...
class ExpectedUtilityBestOption(AcquisitionFunction):
    r""""""
    ...
    def __init__(
        ...
        r"""Analytic Expected Utility of the Best Option.
    ...
    def forward(self, X: Tensor) -> Tensor:
        r"""Evaluate on the candidate set X.
        Args:
...
class qExpectedUtilityBestOption(MCAcquisitionFunction):
    r""" """
